...
Ziel ist es Decks des Kartenspiels Gwent zu simulieren. Und diese zu bewerten.

Dieses Projekt besteht aus zwei Teilen. Einem Deckbauer des digitalen 
Kartenspiels Gwent und einem Simulator, der aus einem Deck die Starthand 
zieht und die Bewertung dieser ermöglicht.

Das Projekt soll eine Datenbank verwenden und Zugriff auf eine externe API
benötigen. Außerdem soll es einen Zugriffsgeschützten Bereich geben.

Die Stakeholder sind Spieler von Gwent, die Decks erstellen und überprüfen
möchten, bevor sie Geld und Zeit dafür aufwenden die Karten zu erhalten 
...
**UC01: Karten anzeigen**
Als Nutzer will ich alle Karten sehen können um mir passende Karten für mein Deck auswählen zu können.

**UC02: Anführer wählen**
Als Nutzer will ich einen Anführer für mein Deck auswählen, um die Menge an Karten für mein Deck zu begrenzen und um die Anforderungen an ein Deck zu erfüllen.

**UC03: Nutzer registrieren**
Als Nutzer will ich mich registrieren, um mein Deck abspeichern zu können. 

**UC04: Nutzer anmelden**
Als Nutzer will ich mich anmelden, um auf mein Deck zuzugreifen.

**UC05: Deck bauen**
Als angemeldeter Nutzer will ich Karten für mein Deck auswählen, um mein Deck zusammenzustellen.

**UC06: Deck speichern**
Als angemeldeter Nutzer will ich mein Deck abspeichern, um später weiter daran zu arbeiten.
...
**Welche Programmiersprache?** Es wurde Java gewählt, weil diese Sprache 
der Programmiererin bereits bekannt ist.

**Wie wird die UI erstellt?** Mit Thymeleaf und Bootstrap, weil das die 
Anzeige erleichtert und verschönert und weil Bootstrap bereits bekannt ist.

**Wie werden Bilder ans Frontend gegeben?** Momentan als Bytestring - 
Konsequenz muss vor Produktivsetzung in TODO geändert werden

**Wie wird die Datenbankstruktur generiert?** Momentan mit Hibernate, weil 
das einfach funktioniert hat - Konsequenz: nicht sehr Zukunftsträchtig. 
Am besten vor Produktivsetzung noch mit TODO ersetzen

**Welche Datenbank verwenden?** MariaDB gewählt (TODO: Warum?)

**Was zur Zugriffskontrolle verwenden?** Spring Security, weil das funktioniert.
